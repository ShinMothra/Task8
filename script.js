...
function sendForm() {
    ...
    if (name != "" && message != "" && checkbox.checked && validateEmail(email) != null && validatePhoneNumber(phone)!=null && organization!=" ") {
        ...
        let popupForm = {"name": name, "email": email, "phone":phone, "organization":organization, "message": message};
        ...
        phoneObj.value = "";
        let organizationObj = document.getElementById("organization");
        ...
        result.style.color = "red";
        result.innerHTML = "Заполните форму целиком и дайте согласие на обработку персональных данных!";
    }
}
...
const validatePhoneNumber = (phoneNumber) => {
    ...
    const validPhoneNumberPattern = /^((\+7)|8)\d{10}$/;
    return validPhoneNumberPattern.test(cleaned);
};